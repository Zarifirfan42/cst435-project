...
class PipelineServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessChunk = channel.unary_unary(
                '/pipeline.PipelineService/ProcessChunk',
                request_serializer=pipeline__pb2.ChunkRequest.SerializeToString,
                response_deserializer=pipeline__pb2.ChunkResponse.FromString,
...
def add_PipelineServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessChunk': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pipeline__pb2.ChunkRequest.FromString,
                    response_serializer=pipeline__pb2.ChunkResponse.SerializeToString,
            ),
    }
...
class PipelineService(object):
    ...
    def ProcessChunk(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/pipeline.PipelineService/ProcessChunk',
            pipeline__pb2.ChunkRequest.SerializeToString,
            pipeline__pb2.ChunkResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
